...
public class UIIndicatorCapacityController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (m_playerCount > 2)
        {
            ...
            switch (m_playerID)
            {
                case 0:
                    ...
                    m_gridLayoutGroup.padding.left = 75;
                    m_gridLayoutGroup.padding.top = -546;
                    //Cell size
                ...
                case 1:
                    ...
                    m_gridLayoutGroup.padding.top = -546;
                    m_gridLayoutGroup.padding.left = 1025;
                    //Cell size
                    cellSize = m_gridLayoutGroup.cellSize;
                    cellSize /= 2;
                    m_gridLayoutGroup.cellSize = cellSize;
                    ...
                    break;
                case 2:
                    m_gridLayoutGroup.padding.top = -6;
                    m_gridLayoutGroup.padding.left = 75;
                    //Cell size
                    cellSize = m_gridLayoutGroup.cellSize;
                    cellSize /= 2;
        ...
        else if (m_playerCount == 2)
        {
            ...
            {
                case 0:
                    m_gridLayoutGroup.padding.left = 72;
                    m_gridLayoutGroup.padding.top = -546;
                    ////Cell size
                    cellSize = m_gridLayoutGroup.cellSize;
                    cellSize /= 2f;
                ...
                case 1:
                    ...
                    m_gridLayoutGroup.padding.top = -2;
                    m_gridLayoutGroup.padding.left = 72;
                    ////Cell size
                    cellSize = m_gridLayoutGroup.cellSize;
                    cellSize /= 2f;
