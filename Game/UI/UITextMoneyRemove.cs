...
public class UITextMoneyRemove : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_moneyRemoveCount = 0;
        m_prevMoneyCount = m_entityPlayer.Money;

        //On met l'alpha à 0
        m_text.faceColor = new Color(m_text.faceColor.r, m_text.faceColor.g, m_text.faceColor.b, 0);
    ...
    private void Update()
    {
        ...
        if (m_moneyChangeFadeTimer > 0)
        {
            ...
            //On addapte l'alpha
            m_text.faceColor = new Color(m_text.faceColor.r, m_text.faceColor.g, m_text.faceColor.b, 1f * m_moneyChangeFadeTimer / m_moneyChangeFadeTimerMax);
