...
public class SwordShop : MonoBehaviour
{
    ...
    void ShowAndHideWeapons()
    {
        if (shopBelonging == "Red")
        {
            if (m_playerRed != null)
            {
                if (m_playerRed.GetComponentInChildren<GetHand>().hand.transform.Find("Sword") != null)
                {
        ...
        {
            if (m_playerBlue != null)
            {
                if (m_playerBlue.GetComponentInChildren<GetHand>().hand.transform.Find("Sword") != null)
                {
                    sword.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
        ...
        {
            if (m_playerGreen != null)
            {
                if (m_playerGreen.GetComponentInChildren<GetHand>().hand.transform.Find("Sword") != null)
                {
                    sword.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
        ...
        {
            if (m_playerYellow != null)
            {
                if (m_playerYellow.GetComponentInChildren<GetHand>().hand.transform.Find("Sword") != null)
                {
                    sword.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
    ...
    void ShowUI()
    {
        ...
        {
            if (sword.GetComponentInChildren<MeshRenderer>().enabled == true)
            {
                    ...
                    if (InputManager.Instance.GetLayoutDevice(controller.device) == "Keyboard")
                    {
                        if (Input.GetKeyDown(KeyCode.E))
                        {
                            ...
                            if (weapons.HaveFirstWeapon == true)
                            {
                                ...
                                weapons.PlayerWeapons[0] = sword.name;
                                weapons.IndexFirstWeapon = 0;
                            ...
                            else if (weapons.HaveFirstWeapon == false)
                            {
                                ...
                                weapons.PlayerWeapons[1] = sword.name;
                                weapons.IndexSecondWeapon = 0;
