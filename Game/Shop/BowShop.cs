...
public class BowShop : MonoBehaviour
{
    ...
    void ShowAndHideWeapons()
    {
        if (shopBelonging == "Red")
        {
            if (m_playerRed)
            {
                if (m_playerRed.GetComponentInChildren<GetHand>().hand.transform.Find("Bow") != null)
                {
                    bow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
                {
                    bow.GetComponentInChildren<MeshRenderer>().enabled = true;
                }
            }
        }
        ...
        else if (shopBelonging == "Blue")
        {
            if (m_playerBlue)
            {
                if (m_playerBlue.GetComponentInChildren<GetHand>().hand.transform.Find("Bow") != null)
                {
                    bow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
        ...
        else if (shopBelonging == "Green")
        {
            if (m_playerGreen)
            {
                if (m_playerGreen.GetComponentInChildren<GetHand>().hand.transform.Find("Bow") != null)
                {
                    bow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
        ...
        else if (shopBelonging == "Yellow")
        {
            if (m_playerYellow)
            {
                if (m_playerYellow.GetComponentInChildren<GetHand>().hand.transform.Find("Bow") != null)
                {
                    bow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
    ...
    void ShowUI()
    {
        ...
        {
            if (bow.GetComponentInChildren<MeshRenderer>().enabled == true)
            {
                    ...
                    if (InputManager.Instance.GetLayoutDevice(controller.device) == "Keyboard")
                    {
                        if (Input.GetKeyDown(KeyCode.E))
                        {
                            ...
                            if (weapons.HaveFirstWeapon == true)
                            {
                                ...
                                weapons.PlayerWeapons[0] = bow.name;
                                weapons.IndexFirstWeapon = 2;
                            ...
                            else if (weapons.HaveFirstWeapon == false)
                            {
                                ...
                                weapons.PlayerWeapons[1] = bow.name;
                                weapons.IndexSecondWeapon = 2;
    ...
    void OnTriggerExit(Collider collider)
    {
        if (collider.CompareTag("Player"))
        {
            if (shopBelonging == "Red")
            {
                ...
                {
                    playerInShop = false;
                    if (weapons.WeaponSelected == "BareHand")
                    {
                        weapons.SelectWeapon1();
                    }
                }
