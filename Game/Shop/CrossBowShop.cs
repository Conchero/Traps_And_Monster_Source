...
public class CrossBowShop : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        crossBow = gameObject.transform.Find("CrossBow").gameObject;
    ...
    void ShowAndHideWeapons()
    {
        if (shopBelonging == "Red")
        {
            if (m_playerRed)
            {
                if (m_playerRed.GetComponentInChildren<GetHand>().hand.transform.Find("CrossBow") != null)
                {
                    crossBow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
                {
                    crossBow.GetComponentInChildren<MeshRenderer>().enabled = true;
                }
            }
        }
        ...
        else if (shopBelonging == "Blue")
        {
            if (m_playerBlue)
            {
                if (m_playerBlue.GetComponentInChildren<GetHand>().hand.transform.Find("CrossBow") != null)
                {
                    crossBow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
        ...
        else if (shopBelonging == "Green")
        {
            if (m_playerGreen)
            {
                if (m_playerGreen.GetComponentInChildren<GetHand>().hand.transform.Find("CrossBow") != null)
                {
                    crossBow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
        ...
        else if (shopBelonging == "Yellow")
        {
            if (m_playerYellow)
            {
                if (m_playerYellow.GetComponentInChildren<GetHand>().hand.transform.Find("CrossBow") != null)
                {
                    crossBow.GetComponentInChildren<MeshRenderer>().enabled = false;
                }
                else
    ...
    void ShowUI()
    {
        ...
        {
            if (crossBow.GetComponentInChildren<MeshRenderer>().enabled == true)
            {
                    ...
                    if (InputManager.Instance.GetLayoutDevice(controller.device) == "Keyboard")
                    {
                        if (Input.GetKeyDown(KeyCode.E))
                        {
                            ...
                            if (weapons.HaveFirstWeapon == true)
                            {
                                ...
                                weapons.PlayerWeapons[0] = crossBow.name;
                                weapons.IndexFirstWeapon = 4;
                            ...
                            else if (weapons.HaveFirstWeapon == false)
                            {
                                ...
                                weapons.PlayerWeapons[1] = crossBow.name;
                                weapons.IndexSecondWeapon = 4;
